...
# charger l'image d'entrée à partir du disque, la cloner et récupérer l'image spatiale
# dimensions
...
# passer le blob à travers le réseau et obtenir les détections de visage
...
for i in range(0, detections.shape[2]):
	...
	if confidence > args["confidence"]:
		...
		# the object
		# calculer les coordonnées (x, y) de la boîte englobante pour
		# L'object
